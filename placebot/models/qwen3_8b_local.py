# Qwen 3 8B Local Model Profile
# Alibaba Qwen 3 via Ollama - Local LLM Configuration

MODEL_NAME = "Qwen 3 8B (Local)"
...
SPEED = "Fast (RTX 4090)"
ACCURACY = "High (8B parameter model)"
...
LOCAL_MODEL_INFO = {
    "hardware_requirements": "GPU recommended, 8GB+ VRAM ideal",
    "inference_speed": "~3-6 tokens/second on RTX 4090",
