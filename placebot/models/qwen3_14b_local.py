# Qwen 3 14B Local Model Profile
# Alibaba Qwen 3 via Ollama - Local LLM Configuration

MODEL_NAME = "Qwen 3 14B (Local)"
...
SPEED = "Medium (RTX 4090)"
ACCURACY = "Very High (14B parameter model)"
COST_EFFICIENCY = "Perfect (Free)"
BEST_FOR = "Privacy-focused, cost-free processing, highest quality"
...
LOCAL_MODEL_INFO = {
    "hardware_requirements": "GPU recommended, 12GB+ VRAM ideal",
    "inference_speed": "~2-4 tokens/second on RTX 4090",
